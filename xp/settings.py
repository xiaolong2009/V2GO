...
DATABASES = {
    'default': {
        ...
        'NAME': 'myforum',                      # Or path to database file if using sqlite3.
...
# URL that handles the medi`a served from MEDIA_ROOT. Make sure to use a
# trailing slash.
...
SECRET_KEY = '8jdc52q*^n-l*o1%iauf-3h2s!z76#n0y3coaw1ol_#gljb=*z'
